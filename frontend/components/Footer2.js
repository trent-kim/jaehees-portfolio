...
const Footer = ({ about = [] }) => {
  ...
  return (
    <div className={`${show ? 'bottom-[0px]' : 'bottom-[-53px]'} transition-bottom duration-500  ease-[cubic-bezier(.23,1,.32,1)] bg-white border-t border-black flex flex-col sm:flex-row sm:fixed bottom-[0px] w-full z-30`}>
